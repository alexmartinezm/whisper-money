...
/**
 * Writes the "why this happened" paragraphs that open a user's monthly analysis.
 * Unlike {@see ReportSummaryAgent}, which talks to us in an admin channel, this
 * one talks to the user, in their own language.
 *
 ...
 * a transaction description or a merchant: that boundary is stated to the reader
 * beside the analysis, so it has to hold here.
 */
class MonthlySummaryAgent implements Agent
{
    ...
    {
        return <<<PROMPT
        You write the short analysis that opens the monthly report of a
