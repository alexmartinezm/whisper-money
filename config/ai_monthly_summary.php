...
return [
    ...
    | monthly report for Pro users who have granted AI consent. A
    ...
    */
    ...
    | attempts are spent, the month is shown without the section.
    |
    */
    ...
    | figures, so a runaway answer would push them below the fold.
    |
    */
