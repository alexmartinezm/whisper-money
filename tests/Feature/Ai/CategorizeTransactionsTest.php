...
it('drops the chunk, skips reporting and schedules a retry when the provider fails transiently', function (Throwable $failure) {
    $user = User::factory()->create();
    groceries($user);
    $transaction = uncategorized($user);
    ...
    TransactionCategorizationAgent::fake(fn () => throw $failure);
